...
module.exports = function(base_uri) {
	...
	module.sendTemperature = function (temperature) {
		return sendSensorData.call(this, 'temperature', {temperature: temperature});
	};

	module.sendPressure = function (pressure) {
		return sendSensorData.call(this, 'pressure', {pressure: pressure});
	};

	module.sendHumidity = function (humidity) {
		return sendSensorData.call(this, 'humidity', {humidity: humidity});
	};

	module.sendColor = function (color) {
		return sendSensorData.call(this, 'color', {color: color});
	};

	module.sendGas = function (gas) {
		return sendSensorData.call(this, 'gas', {gas: gas});
	};

	module.sendButton = function (state) {
		return sendSensorData.call(this, 'button', {button: {state: state}});
	};
